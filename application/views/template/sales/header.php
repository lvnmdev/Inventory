    ...
    <header>
            ...
            <div class="mainHeader">
                <div class="row">
                    <div class="col-sm-12 col-xs-12 col-md-6">
                        <div class="logo">
                            <h1><a href="<?php echo base_url("Sales/index")?>"><?php echo $pageTitle ?></a></h1><h1></h1>
                        </div>
                    </div>
                    <div class="col-sm-12 col-xs-12 col-md-6">
                        <div class="employee-info">
                            <h5>Welcome! <a href="<?php echo base_url("Sales/profile")?>">Elvin Mendoza</a>! [Admin] | <a href="<?php echo base_url("Main/login")?>">Log Out</a></h5>
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <nav class="nav-web">
            <div class="text-center">
                <ul class="breadcrumb">
                    <li class=""><a href="<?php echo base_url("Sales/index")?>">DASHBOARD</a></li>
